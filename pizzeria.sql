...
INSERT INTO `active_adresses` VALUES (17, 1, 2);
...
-- ----------------------------
INSERT INTO `delivery_adresses` VALUES (1, 'Kamienna', '1', '2', '40-500', 'Mielec', 0, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_polish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ordered_sauces
-- ----------------------------
INSERT INTO `ordered_sauces` VALUES (1, 1, 1.99, 4);
...
-- ----------------------------
-- Table structure for orders_ordered_sauces
-- ----------------------------
DROP TABLE IF EXISTS `orders_ordered_sauces`;
CREATE TABLE `orders_ordered_sauces`  (
  `id_order` int(10) UNSIGNED NOT NULL,
  `id_ordered_sauces` int(10) UNSIGNED NOT NULL,
  INDEX `id_order`(`id_order`) USING BTREE,
  INDEX `id_ordered_sauces`(`id_ordered_sauces`) USING BTREE,
  CONSTRAINT `orders_ordered_sauces_ibfk_1` FOREIGN KEY (`id_order`) REFERENCES `orders` (`id_order`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `orders_ordered_sauces_ibfk_2` FOREIGN KEY (`id_ordered_sauces`) REFERENCES `ordered_sauces` (`id_ordered_sauce`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_polish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of orders_ordered_sauces
-- ----------------------------
...
-- Records of pizza
-- ----------------------------
INSERT INTO `pizza` VALUES (1, 'margarita', 2, 2, 7, 0);
...
INSERT INTO `pizza` VALUES (47, 'test', 1, 1, 1, 13.48);
INSERT INTO `pizza` VALUES (48, 'test', 1, 1, 1, 13.48);
INSERT INTO `pizza` VALUES (49, 'test', 1, 1, 1, 13.48);
INSERT INTO `pizza` VALUES (50, 'test', 1, 1, 1, 13.48);
...
INSERT INTO `pizzas_ingredients` VALUES (48, 1);
INSERT INTO `pizzas_ingredients` VALUES (48, 1);
INSERT INTO `pizzas_ingredients` VALUES (48, 1);
INSERT INTO `pizzas_ingredients` VALUES (48, 1);
INSERT INTO `pizzas_ingredients` VALUES (48, 1);
...
INSERT INTO `pizzas_ingredients` VALUES (48, 1);
INSERT INTO `pizzas_ingredients` VALUES (48, 1);
INSERT INTO `pizzas_ingredients` VALUES (49, 1);
INSERT INTO `pizzas_ingredients` VALUES (49, 1);
INSERT INTO `pizzas_ingredients` VALUES (49, 1);
INSERT INTO `pizzas_ingredients` VALUES (49, 1);
INSERT INTO `pizzas_ingredients` VALUES (49, 1);
...
INSERT INTO `pizzas_ingredients` VALUES (49, 1);
INSERT INTO `pizzas_ingredients` VALUES (49, 1);
INSERT INTO `pizzas_ingredients` VALUES (50, 1);
INSERT INTO `pizzas_ingredients` VALUES (50, 2);
INSERT INTO `pizzas_ingredients` VALUES (50, 2);
INSERT INTO `pizzas_ingredients` VALUES (50, 2);
INSERT INTO `pizzas_ingredients` VALUES (50, 2);
INSERT INTO `pizzas_ingredients` VALUES (50, 2);
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'Piotr', 'Ciosmak', 'piotrciosmak2001@gmail.com', '000-000-123', 'mężczyzna');
...
delimiter ;;
CREATE PROCEDURE `?add_pizza`(IN `v_pizza` varchar(255),IN `v_id_dough` int,IN `v_id_size` int,IN `v_id_sauce` int,IN `list_of_ingredients_id` varchar(255))
BEGIN
	START TRANSACTION;
	...
	VALUES (v_pizza, v_id_dough, v_id_size, v_id_sauce, 0);

	SET @last_insert_id := 0;
	SELECT @last_insert_id := MAX(id_pizza) FROM pizza;
	
	#to nie działa (chce tu dodawać składniki pizzy przekazane w liście list_of_ingredients_id 
	SET @i := 0;
	SET @ingredient_id := 0;
	WHILE @i < LENGTH(list_of_ingredients_id) DO
		SET @ingredient_id := SUBSTR(list_of_ingredients_id,@i+1,1);
		CALL add_pizzas_ingredient(@last_insert_id, @ingredient_id);
		SET @i := 1;
	END WHILE;
	#to nie działa


	SELECT @tmp := SUM(price)
	FROM pizzas_ingredients p, ingredients i
	WHERE p.id_pizza = @last_insert_id AND i.id_ingredient = p.id_ingredient;
	SET @final := @final + @tmp;
	
	UPDATE pizza
	SET final_price = @final
	WHERE id_pizza = @last_insert_id;
...
-- ----------------------------
-- Procedure structure for ?set_active_adress
-- ----------------------------
DROP PROCEDURE IF EXISTS `?set_active_adress`;
delimiter ;;
CREATE PROCEDURE `?set_active_adress`(IN `v_id_customer` int,IN `v_id_delivery_adress` int)
BEGIN
	START TRANSACTION;
	
	#IF(expr1,expr2,expr3)
	
	DELETE FROM active_adresses
	WHERE id_customer = v_id_customer;
	
	INSERT INTO active_adresses(id_customer, id_delivery_adress)
	VALUES (v_id_customer, v_id_delivery_adress);
...
BEGIN
	...
	SET apartment_number = v_apartment_number
